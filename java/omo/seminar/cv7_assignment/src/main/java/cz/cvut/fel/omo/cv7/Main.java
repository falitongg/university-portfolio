...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AbBankFactory AbFactory = AbBankFactory.getInstance();
        UniBankFactory UniFactory = UniBankFactory.getInstance();

        AbstractBankFactory[] factories = {UniFactory, AbFactory};
