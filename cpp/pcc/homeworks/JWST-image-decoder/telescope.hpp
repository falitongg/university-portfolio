 ...
 * step muze byt vetsi nez pocet radku.
 *
 * V tomto pripade optimalizujte vypocet!!!
 */
 ...
 * Pokud je step nulove, rotace neprobehne.
 * step muze byt vetsi nez pocet sloupcu.
 *
 * V tomto pripade optimalizujte vypocet!!!
 */                                                     
...
/*
 * Deklarace bodu.
 * Bod jednoduse definujeme Point(2, 3) - bod [2, 3], bod ve tretim radku na druhe pozici
 * (cislovano od nuly).
 */
struct Point {
    size_t x, y;
    Point(size_t col, size_t row) : x(col), y(row) {};
};
